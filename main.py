...
background = pygame.image.load(resource_path('back.jpg'))                                  #game background
font = pygame.font.Font(resource_path('comic.ttf'), 42)
score_text = font.render('Score : ' + str(score), True, (255, 255, 255))    #score display
lives_icon = pygame.image.load(resource_path('images/white_lives.png'))                    #images that shows remaining lives

# Generalized structure of the fruit Dictionary
def generate_random_fruits(fruit):
    fruit_path = resource_path("images/" + fruit + ".png")
    data[fruit] = {
...
while game_running :
    if game_over :
        ...
        # reset score and update rendered text
        score = 0
